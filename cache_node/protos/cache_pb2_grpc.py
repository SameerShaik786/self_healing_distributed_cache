...
class CacheServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.Put = channel.unary_unary(
                ...
                request_serializer=cache__pb2.PutRequest.SerializeToString,
                response_deserializer=cache__pb2.PutResponse.FromString,
                _registered_method=True)
...
def add_CacheServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Put': grpc.unary_unary_rpc_method_handler(
                    servicer.Put,
                    request_deserializer=cache__pb2.PutRequest.FromString,
                    response_serializer=cache__pb2.PutResponse.SerializeToString,
            ),
...
class CacheService:
    ...
    def Put(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/cache.CacheService/Put',
            cache__pb2.PutRequest.SerializeToString,
            cache__pb2.PutResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
